...
Important tips: use as few links as possible, because the browser needs to request each file from the server and wait until it has completely loaded.
...
http://caniuse.com checks if you can use something in a specific browser.
